...
syntax keyword cppSTLnamespace __gnu_pbds
syntax keyword cppSTLnamespace std
syntax keyword cppSTLnamespace rb_tree_tag
...
syntax keyword cppSTLtype ordered_set
syntax keyword cppSTLtype tree
...
if !exists("cpp_no_cpp11")
    ...
    syntax keyword cppSTLiterator make_move_iterator
    syntax keyword cppSTLiterator next prev
